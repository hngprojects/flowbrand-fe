      ...
      <div className="mx-auto w-full max-w-[1440px] px-20">
        ...
        <div className="mb-16 text-center md:mb-20">
          <div className="bg-badge-bg mb-2 flex items-center justify-center gap-2 rounded-xl px-4 py-2">
            ...
            <SectionLabelPill>Solution</SectionLabelPill>
          </div>
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="flex justify-center lg:justify-end">
            <div
              className={`relative aspect-[606/468] w-full max-w-[606px] overflow-hidden rounded-[32px] bg-[#E58F17] transition-all duration-500 ${
                activeStep === 0
                  ? 'p-6 sm:p-8 lg:p-10'
