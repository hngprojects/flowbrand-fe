...
const AuthSplitLayout = ({ children }: Readonly<{ children: ReactNode }>) => {
  return (
    <div className="bg-background flex min-h-screen w-full">
        ...
        <div className="max-w-lg">
          ...
          <ul className="space-y-3 text-sm xl:space-y-4 xl:text-base">
            {[
              ...
              <li
                key={i}
                className="text-foreground flex items-start gap-2.5 font-[400] xl:gap-3"
              >
      ...
      <div className="flex h-screen max-h-screen w-full flex-1 flex-col overflow-y-auto px-4 py-6 sm:px-6 sm:py-8 lg:items-center lg:justify-center lg:px-0 lg:py-0">
