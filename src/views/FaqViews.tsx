          ...
          <div className="flex flex-col items-center gap-6 py-12 lg:flex-row lg:items-center lg:justify-between lg:py-16">
            ...
            <div className="relative w-full max-w-xl">
              ...
              <Input
                ...
                className="h-12 rounded-full pr-4 pl-10 shadow-sm"
              />
            </div>
          </div>
        </div>
          ...
          {filteredFaqs.length === 0 ? (
            ...
            <>
                ...
                {filteredFaqs.map((item, index) => (
                  ...
                  >
                    ...
                    <AccordionContent className="px-6 pt-0 pb-6">
                      <div className="space-y-4 rounded-2xl border-t border-gray-100 bg-[#FBFCFF] pt-4 text-sm leading-relaxed text-gray-600 md:text-[15px]">
              ...
              <div className="mt-20 flex flex-col items-center gap-6 pb-12 text-center md:pb-20">
                <h2 className="text-foreground max-w-2xl text-3xl font-medium tracking-tight md:text-4xl lg:text-5xl">
                  Ready To Grow Your Business With A System That Actually Brings
                  Customers?
                </h2>
                ...
                <Link
                  href="/register"
                  className="bg-primary text-primary-foreground hover:bg-primary/90 mt-4 rounded-lg px-8 py-3.5 text-sm font-semibold shadow-md transition-all active:scale-95"
                >
